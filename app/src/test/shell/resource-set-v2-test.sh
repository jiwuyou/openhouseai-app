...
jq -e '
  ...
  .version == "2026.08.09.1" and .sequence == 2026080901 and
...
for required in control-plane-manifest.json start-control-plane-termux-native.sh repair-control-plane-termux-native.sh inspect-control-plane-termux-native.sh; do
