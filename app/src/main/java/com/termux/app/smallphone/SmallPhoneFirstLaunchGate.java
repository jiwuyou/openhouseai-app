...
public final class SmallPhoneFirstLaunchGate {
    ...
    public static Intent getGateIntent(Context context) {
        ...
        OpenHouseOnboardingState state = new OpenHouseStatusRepository(context)
            .loadOnboardingStateWithoutStatusProbe();
        if (state.isComplete()) {
            return null;
        }
    ...
    public static Intent newSmallPhoneHostIntent(Context context) {
        Intent intent = new Intent(context, OpenHouseWebHostActivity.class);
