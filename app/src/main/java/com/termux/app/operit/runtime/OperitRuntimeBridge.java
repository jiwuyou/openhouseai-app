...
public final class OperitRuntimeBridge {
    ...
    public OperitServiceManagerResult getServiceManagerHealth() {
        ...
        try {
            URL url = new URL(SmallPhoneRuntime.SERVICE_MANAGER_HEALTH_URL);
            ...
            return new OperitServiceManagerResult(
                success,
                code,
                SmallPhoneRuntime.SERVICE_MANAGER_HEALTH_URL,
                body,
                message,
                "",
                "",
    ...
    public OperitServiceManagerResult getServiceManagerStatus(String serviceId) {
        ...
        if (cleanServiceId.isEmpty()) {
            return new OperitServiceManagerResult(
                false,
                0,
                SmallPhoneRuntime.SERVICE_MANAGER_URL,
                "",
        ...
        ServiceManagerResult result = new ServiceManagerClient(SmallPhoneRuntime.SERVICE_MANAGER_URL)
