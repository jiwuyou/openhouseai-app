...
printf ','
readiness_object "cc-connect-webclient" "cc-connect/openhouse-connect webclient" "$cc_url" "$cc_reachable" "$cc_connect_required" "$cc_connect_disabled"
printf ']}'
printf ',"components":['
...
printf ','
port_object "cc-connect-webclient" "$cc_url" "$cc_reachable" "$cc_connect_enabled"
printf ','
