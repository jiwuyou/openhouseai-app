...
SmallPhoneAI 运行在 Android Termux 中，并通过 `proot-distro` 提供 Ubuntu。默认核心能力是 Codex CLI、Claude Code、CloudCLI、service-manager、cc-connect/openhouse-connect 和 SmallPhone；运行组件阶段会调用各自仓库入口安装、检查和注册。
