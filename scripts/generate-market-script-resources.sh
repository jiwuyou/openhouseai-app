...
set_version="${OPENHOUSE_MARKET_RESOURCE_SET_VERSION:-2026.09.05.1}"
set_sequence="${OPENHOUSE_MARKET_RESOURCE_SET_SEQUENCE:-2026090501}"
...
runtime_version="${OPENHOUSE_MARKET_RUNTIME_VERSION:-0.2.4}"
