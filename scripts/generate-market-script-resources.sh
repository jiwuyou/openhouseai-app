...
set_version="${OPENHOUSE_MARKET_RESOURCE_SET_VERSION:-2026.08.15.4}"
set_sequence="${OPENHOUSE_MARKET_RESOURCE_SET_SEQUENCE:-2026081504}"
...
setup_version="${OPENHOUSE_MARKET_SETUP_VERSION:-1.0.3}"
