...
object AppLogger {
    ...
    fun bindContext(context: Context) {
        if (boundContext == null) {
            ...
            OperitRuntimeContext.bind(context)
        }
    }
    ...
    private fun resolveLogFile(): File? {
        ...
        return try {
            val appContext: Context = boundContext ?: OperitRuntimeContext.currentOrNull() ?: return null
    ...
    private fun resolvePackageLogFile(): File? {
        ...
        return try {
            ...
            val startupMs = OperitRuntimeContext.startupTimeMs().takeIf { it > 0L } ?: System.currentTimeMillis()
    ...
    fun resetLogFile() {
        try {
            val appContext: Context = boundContext ?: OperitRuntimeContext.currentOrNull() ?: return
            val dir = File(appContext.filesDir, LOG_DIR_NAME)
