...
class WakeWordPreferences(private val context: Context) {
    ...
    companion object {
        ...
        val DEFAULT_WAKE_PHRASE: String by lazy {
            OperitRuntimeContext.getStringOrDefault(R.string.wake_word_default, "")
        }
        val DEFAULT_WAKE_GREETING_TEXT: String by lazy {
            OperitRuntimeContext.getStringOrDefault(R.string.wake_word_response, "")
        }
        val DEFAULT_AUTO_NEW_CHAT_GROUP: String by lazy {
            OperitRuntimeContext.getStringOrDefault(R.string.wake_word_global_assistant, "")
        }
