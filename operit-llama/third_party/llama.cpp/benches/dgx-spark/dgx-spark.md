...
```bash
uname --all
Linux spark-17ed 6.11.0-1016-nvidia #16-Linux SMP PREEMPT_DYNAMIC Sun Sep 21 16:52:46 UTC 2025 aarch64 aarch64 aarch64 GNU/Linux

g++ --version
g++ (Linux 13.3.0-6ubuntu2~24.04) 13.3.0
