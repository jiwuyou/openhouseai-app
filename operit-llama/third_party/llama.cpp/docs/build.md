...
- If you want HTTPS/TLS features, you may install OpenSSL development libraries. If not installed, the project will build and run without SSL support.
  - **Debian / Linux:** `sudo apt-get install libssl-dev`
...
- *Optionally* toolbox packages are available: [Arch Linux](https://archlinux.org/), [Red Hat Enterprise Linux >= 8.5](https://www.redhat.com/en/technologies/linux-platforms/enterprise-linux), or [Linux](https://linux.com/download)
...
On Debian / Linux, you can install the required dependencies using:
```sh
