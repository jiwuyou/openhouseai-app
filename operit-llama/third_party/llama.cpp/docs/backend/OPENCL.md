...
| Linux   | Support | Linux 22.04 WSL2 with Intel 12700H            |
...
Linux 22.04 is used for targeting Android. Make sure the following tools are accessible from command line,
