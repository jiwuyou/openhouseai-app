...
const GOOGLE_GEMINI_CLI_OAUTH_CLIENT_ID: &str =
    "YOUR_GOOGLE_GEMINI_CLI_OAUTH_CLIENT_ID";
// ubs:ignore public installed-app OAuth client metadata, not a server-side secret.
const GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET: &str = "YOUR_GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET";
...
const GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_ID: &str =
    "YOUR_GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_ID";
// ubs:ignore public installed-app OAuth client metadata, not a server-side secret.
const GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_SECRET: &str = "YOUR_GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_SECRET";
